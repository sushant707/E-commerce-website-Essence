    ...
    <footer className={`${showFilter ? "hide-div" : null}`}>
      <div className="about">
        ...
        <div className="social">
          <a href="https://github.com/sushant707" target="_blank">
            <i className="fa fa-github"></i>
          </a>
          <a href="https://twitter.com/Sushant47691431" target="_blank">
            <i className="fa fa-twitter"></i>
          </a>
          <a href="https://www.linkedin.com/in/sushant-chavan-229983260/" target="_blank">
      ...
      <div className="contact">
        ...
        <div className="sub-heading address">
          <i className="fa fa-map-marker"></i>TASGAON, MAHARASHTRA 416311
India
        </div>
